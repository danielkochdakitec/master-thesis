...
plt.plot(x, 60 * ((0.0000175 * x) - (1600000/60 * 0.0000175)).clip(min=0.0), '-', label='Google Cloud Functions', color='#4285F4', alpha=0.8, lw=1)
...
plt.tight_layout()
plt.grid()
plt.savefig('../../bilder/7_2_vergleich-cloud-kosten/functions-compute.pdf')
plt.show()