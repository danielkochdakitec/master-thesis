...
Der \ac{BaaS}-Anbieter Back4App bietet seinen Nutzern eine Liste bekannter weiterer Anbieter \autocite{mbaasComparison}. Diese werden in \autoref{Kap2:BaasAnbieter} folgenden zusammenfassend dargestellt. Die Darstellung der Funktionalitäten zeigt lediglich die für diesen Anbieter wichtigsten Funktionalitäten und ist damit nicht vollständig.
