...
\begin{table}[h]
  \caption{Vergleich von Service-Modellen der Cloud}
  \label{Kap2:ServiceModelleVergleich1}
...
\autoref{Kap2:ServiceModelleVergleich1} vergleicht \ac{IaaS}, \ac{PaaS}, \ac{FaaS}, damit implizit auch \ac{BaaS}, und \ac{SaaS} anhand den Kriterien Entwicklungseffizienz, Skalierbarkeit, Wartung, Kosten und den Anwendern.
...
Die Graphik mit Zitat \autocite{jiang2020overview}

\autoref{TODO2} vergleicht die Service-Modelle ebenfalls uns zeigt auf, welche Elemente von welchem Modell geliefert werden. Dabei ist auffällig, dass von links nach rechts mehr bereitgestellt wird. Für die Neuentwicklung von Anwendungen ist damit \ac{FaaS} und \ac{BaaS} geeignet, da nur die Anwendungslogik geschrieben werden muss.
