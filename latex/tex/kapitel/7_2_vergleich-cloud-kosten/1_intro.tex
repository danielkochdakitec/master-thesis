...
\begin{table}[h]
  ...
  \begin{footnotesize}
    \begin{tabularx}{0.9\textwidth}{l r r}
      ...
      \textbf{Summe (Hosting)} & \$ 372,75 & \$ 373,38 \\
      \emph{} &  &  \\
      ...
      \emph{Datenbank - Lesezugriffe} & \$ 61,00 & \$ 77,81 \\
      \emph{Datenbank - Schreibzugriffe} & \$ 0,04 & \$ 0,00 \\
      \emph{Datenbank - Löschzugriffe} & \$ 0,00 & \$ 0,00 \\
      \emph{Datenbank - Ausgehender Netzwerktransfer} & \$ 1,80 & \$ 1,20 \\
      ...
      \emph{} &  &  \\
      \textbf{Summe (Computing)} & \$ 26,57 & \$ 27,93 \\
      \textbf{Summe (Storage)} & \$ 42.420,14 & \$ 61.878,34 \\
      \textbf{Summe (Datenbank)} & \$ 62,85 & \$ 79,01 \\
      \textbf{Summe (Video-Transkodierung)} & \$ 30,6 & \$ 54 \\
      \textbf{Summe (Sonstiges)} & \$ 80,02 & \$ 0,00 \\
      \emph{} &  &  \\
...
Der Preis ist auf Grund der kostenlosen Kontingente bzw. im Falle der Löschzugriffe auf Grund der geringen Nutzung in vier Fällen gleich. Zwar ist Firebase in den restlichen 57 Prozent der Fälle kostengünstiger als \ac{AWS} Amplify, dennoch ist der Gesamtpreis pro Monat bei Firebase um 45 Prozent höher als der Preis von \ac{AWS} Amplify. Dies lässt sich anhand der deutlich geringeren ausgehenden Netzwerktransferkosten bei \ac{AWS} erklären. Würden diese nicht beachtet werden, ergäbe sich ein relativ ähnliches Bild, nur, dass \ac{AWS} Amplify dann nun 7 Prozent teurer ist.
