...
Im folgenden Kapitel werden die monatlich anfallenden Cloud-Kosten für die entwickelte Software verglichen. Außerdem werden im Kapitel Anwendungsszenarien vorgestellt, um zu ermitteln, für welchen Fall welcher Dienst wirtschaftlicher ist.

\section{Kostenkategorien}

Der Unterarbschnitt stellt die Kosten in unterschiedlichen Kategorien dar. Eine Kategorie kann auf einem oder mehreren Cloud-Diensten bestehen. Zu beachten ist, dass Amazon Cognito in der Preiskalkulation vernachlässigt wird. Der Dienst ist kostenlos, sofern die erweiterten Sicherheitsfunktionalitäten nicht aktiv sind. Diese werden für die Software nicht benötigt. Seitens Firebase gibt es hier ebenfalls keine extra Kosten pro Nutzer.

\subsection{Hosting}

Amplify Hosting verglichen mit Firebase Hosting
