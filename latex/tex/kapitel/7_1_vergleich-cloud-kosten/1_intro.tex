...
\begin{figure}%
    \centering
    \subfloat[\centering Gespeicherte Daten]{{\includegraphics[width=6cm]{7_1_vergleich-cloud-kosten/storage-amount.pdf} }}%
    \qquad
    \subfloat[\centering Get-Anfragen]{{\includegraphics[width=6cm]{7_1_vergleich-cloud-kosten/storage-get.pdf} }}%
    \caption{Kostenvergleich zwischen Amazon S3 und Google Cloud Storage}%
    \label{kostenvergleichStorage}%
    \qquad
    \subfloat[\centering Put/Post/List-Anfragen]{{\includegraphics[width=6cm]{7_1_vergleich-cloud-kosten/storage-put.pdf} }}%
    \caption{Kostenvergleich zwischen Amazon S3 und Google Cloud Storage}%
    \label{kostenvergleichStorage}%
\end{figure}
